<?php
require_once strtr(realpath(dirname(dirname(__FILE__))), '\\', '/') . '/abandonedcartschedulesent.class.php';
/**
 ...
 */
class AbandonedCartScheduleSent_mysql extends AbandonedCartScheduleSent
{
